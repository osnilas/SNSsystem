...
> Each employee is assigned a certain role when registered by an administrator, such as a nurse, receptionist or coordinator. 

> Only the administrators and coordinators have acess to the list of employees 
...
* List of the employees and their defined roles/functions
