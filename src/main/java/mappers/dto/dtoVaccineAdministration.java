...
public class dtoVaccineAdministration {
        ...
        public dtoVaccineAdministration(String brand, List<Integer> minAge, List<Integer> maxAge, List<Double> dosage, List<Integer> doses, List<Integer> vaccineInterval) {
            this.brand = brand;
            this.minAge = minAge;
            this.maxAge = maxAge;
            this.dosage = dosage;
