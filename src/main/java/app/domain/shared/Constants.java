...
public class Constants {
    ...
    public static final LocalTime OPENING_TIME_LEGACY_SYSTEM = LocalTime.of(8, 00);
    public static final LocalTime CLOSING_TIME_LEGACY_SYSTEM = LocalTime.of(20, 00);
    ...
    public static final SNSuser SNS_USER_TESTER_ONE = new SNSuser("Pedro Cardoso", SexListFull[0], (LocalDate.of(2004, 9, 1)), "Rua da maria", "pedro@gmail.com", 91234569, 122137500, 17555688, "pedroTest");
    ...
    public static String BinFile_Directory = Utils.ReadProppeties("BinFiles.Directory");
    public static String TestDocs_Directory = Utils.ReadProppeties("TestDocs.Directory");
